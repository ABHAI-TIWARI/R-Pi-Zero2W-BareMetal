...
// -----------------------------------------------------------------------
// Pin assignments — RGB LED (common cathode, 330Ω per channel)
// Physical pin 11 = GPIO 17 → Red
// Physical pin 13 = GPIO 27 → Green
// Physical pin 15 = GPIO 22 → Blue
// -----------------------------------------------------------------------
#define RGB_RED_GPIO        17u
#define RGB_GREEN_GPIO      27u
#define RGB_BLUE_GPIO       22u

// -----------------------------------------------------------------------
// Pin assignments — Tactile switches (4.7k pull-up → active LOW)
// Physical pin 36 = GPIO 16 → Switch 1 (Next colour)
// Physical pin 38 = GPIO 20 → Switch 2 (Previous colour)
// -----------------------------------------------------------------------
#define SW1_GPIO            16u
#define SW2_GPIO            20u
